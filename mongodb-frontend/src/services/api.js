...
// Base API URL - Properly handling potential empty API_URL
...
// Configure axios for proxy usage in development environment
if (process.env.NODE_ENV === "development" && !process.env.REACT_APP_API_URL) {
  // This will use the proxy setting defined in package.json when no API_URL is provided
